...
public class ToPerformMouseHoverUsingCoordinates {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    //Using moveToLocation() to mousehover on specific located element
		actions.moveToLocation(620, 120).perform();  //to mousehover on HomeAppliances
		Thread.sleep(2000);
		actions.moveToLocation(820, 120).perform(); //to mousehover on Computers
	}
